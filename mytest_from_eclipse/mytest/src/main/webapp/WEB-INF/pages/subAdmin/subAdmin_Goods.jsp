						...
						<div class="row">
						  <div class="col-md-2">
								...
								<div class="panel panel-default" style="margin-bottom: 0;">
								  ...
								  <table class="table">
								    <tr><td onclick="GoodsAdd()">商品添加</td></tr>
								    <tr><td>淘宝商品导入</td></tr>
								    <tr><td>商品查询</td></tr>
								    <tr><td>商品库存</td></tr>
								    <tr><td>商品绑定</td></tr>
						  ...
						  <div class="col-md-10">
							  ...
							  <div class="panel-body">
								<form class="form-inline" style="margin-bottom: 5px;" name="form1" action="subAdmin_queryGoods.do" method="post">
								...
								<div class="row" style="padding-bottom: 5px;">
									...
									&nbsp;&nbsp; &nbsp; &nbsp;
									<button type="button" class="btn btn-info" onclick="queryGoods()">查询</button>		
									  </div>
								</div>
								<div class="row" style="padding-bottom: 5px;">
									  <div class="col-md-12">
...
function GoodsAdd(){
	document.form1.action="adminSub_add.do";
	document.form1.submit();
}
</script>	
</body>
