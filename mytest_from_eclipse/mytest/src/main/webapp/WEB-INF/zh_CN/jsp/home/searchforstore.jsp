    ...
    <div class="body_main" style="min-height: 418px; margin-bottom: 50px;padding: 10px 130px;margin-bottom: 10px;">
				...
				<c:if test="${not empty List}">
						<c:forEach items="${List}" var="item">
								<div class="stlist">
									<div class="stlist_id">
										<a target="_blank" href="#"><img class="lazy" src="<c:out value='${item.StoreUrl}'/>"></a>									
									</div>
									<div class="stname">
									<a target="_blank" href="/Home/Goods/4309086" class="search_list_text" goods_id="4309086"><c:out value='${item.StoreName}'/></a></div>
									<div class="stdesc"><c:out value='${item.StoreDesc}'/></div>
								</div>
							</c:forEach>
					</c:if>	
					<c:if test="${not empty List}">
